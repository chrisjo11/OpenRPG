...
class Player(pygame.sprite.Sprite):
    ...
    def update(self, pressed_keys, isCollided, lastkey):
        ...
        elif pressed_keys[K_DOWN] and not(lastkey = "Up" and isCollided):
            self.spritey += 0.3
            self.lastKeyPressed = "Down"
        elif pressed_keys[K_LEFT] and not(lastkey = "Up" and isCollided):
            self.spritex -= 0.3
            self.lastKeyPressed = "Left"
        elif pressed_keys[K_RIGHT] and not(lastkey = "Up" and isCollided):
            self.spritex += 0.3
